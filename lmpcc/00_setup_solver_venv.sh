...
PYTHON38_EXISTS=$(python3.8 -c 'import sys; print(sys.version_info[:])')
...
python3.8 -m venv ../lmpcc_solver/scripts/venv
source ../lmpcc_solver/scripts/venv/bin/activate
python3.8 -m pip install -r ~/forces_pro_client/requirements.txt
deactivate
