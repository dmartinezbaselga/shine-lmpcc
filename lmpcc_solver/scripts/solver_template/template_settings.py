...
"""
This is a template settings file that can be copied for new systems.
"""
...
# --- Interface Selection --- #
interfaces = # @todo [<INTERFACE_NAME>]  # Define the interfaces that this solver can run with (note the brackets!)
...
if use_ellipsoid_constraints or use_gaussian_constraints:
    modes = 1
    max_obstacles = 8      # Maximum dynamic obstacles to evade with the planner
...
weight_list.append('acceleration')
weight_list.append('angular_velocity')
weight_list.append('slack')
weight_list.append('velocity')
weight_list.append('velocity_reference')
weight_list.append('lateral')
